      ...
      <div>
        <div className="bg-white flex flex-col p-4 md:w-fit w-full mx-auto h-screen justify-center ">
          ...
          <input
            ...
            type="email"
            className="h-12 mb-4 focus:border-none flex flex-wrap bg-white border border-gray-400 rounded-lg px-3 py-2 text-lg font-sans font-normal tracking-normal text-left focus:outline-none focus:ring-2 focus:ring-[#248f59]"
          />
          {/* ERROR */}
          ...
          <input
            ...
            type="password"
            className="h-12 focus:border-none mb-4 flex flex-wrap  bg-white border border-gray-400 rounded-lg px-3 py-2 text-lg font-sans font-normal tracking-normal text-left focus:outline-none focus:ring-2 focus:ring-[#248f59]"
          />
          {/* COMPLETE REGISTRATION */}
          <button
            onClick={handleSubmit}
            className="h-12 my-3 flex flex-wrap transition-transform hover:scale-95 justify-center items-center rounded-lg w-full bg-[#248F59] uppercase text-[#f2f2f2] hover:text-white"
          >
