    ...
    <>
      <section className="relative flex h-full flex-col">
        ...
        <footer className="fixed bottom-0 font-sans w-full max-w-xs bg-white py-5">
          <button
            className="flex h-12 w-full justify-between rounded-full bg-[#248F59] p-1 text-sm font-bold shadow-700 transition-colors focus:outline-none md:h-14"
            onClick={handleLogin}
          >
            ...
            <span className="flex h-full shrink-0 items-center rounded-full bg-white px-4 ">
              Rs:{GrandTotal}
            </span>
          </button>
        </footer>
